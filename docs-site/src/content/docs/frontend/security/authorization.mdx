...
- [Granit.Authorization module](/reference/modules/security/) — .NET policy-based authorization
- [Authentication](./authentication/) — Must be authenticated before checking permissions
- [Identity](./identity/) — Provider capabilities may affect role management
