...
- [Granit.Templating module](/reference/modules/templating/) — .NET Scriban template engine with EF store
- [Workflow](./workflow/) — Templates use `WorkflowLifecycleStatus` for publication lifecycle
