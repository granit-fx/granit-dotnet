...
- [Granit.ReferenceData module](/reference/modules/localization/) — .NET reference data with i18n labels and CRUD endpoints
- [Localization](./localization/) — Country labels use the same multilingual pattern
