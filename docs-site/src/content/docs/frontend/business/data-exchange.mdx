...
- [Granit.DataExchange module](/reference/modules/data-exchange/) — .NET import/export pipeline (Extract → Map → Validate → Execute)
- [Querying](./querying/) — Export jobs apply the same filter/sort/preset parameters
