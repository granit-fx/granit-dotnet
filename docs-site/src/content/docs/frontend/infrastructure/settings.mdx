...
- [Granit.Settings module](/reference/modules/settings-features/) — .NET cascaded settings with EF Core store
- [Localization](./localization/) — `SETTING_NAMES.PREFERRED_CULTURE` stores the user's preferred language
