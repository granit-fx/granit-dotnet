...
- [Granit.BlobStorage module](/reference/modules/blob-storage/) — .NET server-side blob storage (S3-compatible)
- [Localization](./localization/) — Uses `dd:locale` via this storage system
