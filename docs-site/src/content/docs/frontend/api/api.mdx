...
- [Granit.Core module](/dotnet/core/module-system/) — .NET foundation (exception hierarchy, batch operations)
- [Granit.Idempotency module](/dotnet/api/api/) — .NET idempotency middleware
