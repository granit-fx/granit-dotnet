...
[RFC 7807 Problem Details](/reference/modules/core/#exception-hierarchy) returned by
...
- [Granit.Core module](/reference/modules/core/) — .NET foundation (exception hierarchy, batch operations)
- [Granit.Idempotency module](/reference/modules/api-web/) — .NET idempotency middleware
