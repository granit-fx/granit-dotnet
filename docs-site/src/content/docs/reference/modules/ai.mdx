...
|--------|-------------|----------------|
| **DataExchange.AI** | AI column mapping for CSV/Excel import — handles cryptic columns like `Nom_Clt_V2_Final` | [AI: Import Mapping](/ai/import-mapping/) |
| **AI.Extraction** | Extract typed C# objects from documents (invoice PDF → `InvoiceData` record) | [AI: Document Extraction](/ai/document-extraction/) |
| **Querying.AI** | Natural language → structured filters ("unpaid invoices from last week") | [AI: Natural Language Query](/ai/natural-language-query/) |
| **AI.VectorData** | Semantic search / RAG — find documents by meaning, build knowledge bases | [AI: Semantic Search & RAG](/ai/semantic-search/) |
...
- [Data Exchange](/reference/modules/data-exchange/) — import/export module where AI mapping plugs in
- [Querying](/reference/modules/utilities/) — query engine where NLQ translates natural language
