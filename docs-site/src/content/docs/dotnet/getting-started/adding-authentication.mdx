...
:::note[Good to know]
`GranitJwtBearerKeycloakModule` transitively depends on `GranitJwtBearerModule` — you do not need to declare both. The module system resolves the full dependency graph for you.
:::
