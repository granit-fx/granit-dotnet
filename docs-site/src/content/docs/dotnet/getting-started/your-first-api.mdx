...
In this first step, you will create a new .NET project, define a Granit module, add a
domain model, and expose a working endpoint — all with zero manual DI configuration.
