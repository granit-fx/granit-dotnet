...
`TimeoutSeconds` is intentionally high (60s default) — log analysis batches can be large.
...
- [Observability](/dotnet/observability/observability-otlp/) — the observability module
