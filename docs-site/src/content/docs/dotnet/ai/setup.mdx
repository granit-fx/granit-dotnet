...
[Granit.Vault](/dotnet/security/vault-encryption/) with dynamic rotation.
:::
...
- [Querying](/dotnet/core/utilities/) — query engine where NLQ translates natural language
- [Persistence](/dotnet/data/persistence/) — isolated DbContext pattern, `ApplyGranitConventions`
- [Vault & Encryption](/dotnet/security/vault-encryption/) — secure API key storage with rotation
- [Observability](/dotnet/observability/observability-otlp/) — OpenTelemetry integration for AI call tracing
