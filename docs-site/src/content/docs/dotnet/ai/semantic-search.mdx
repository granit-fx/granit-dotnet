...
- [AI: Document Extraction](/ai/document-extraction/) — extract text from PDFs for indexing
- [AI: Natural Language Query](/ai/natural-language-query/) — structured filter search (complementary to semantic search)
