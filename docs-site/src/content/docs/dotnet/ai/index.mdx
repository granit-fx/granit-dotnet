...
|------------|--------|-------------|
| **Chat & generation** | [Granit.AI](/reference/modules/ai/) | Workspace-managed access to `IChatClient` (OpenAI, Azure, Claude, Ollama) |
| **Import mapping** | [DataExchange.AI](/ai/import-mapping/) | Automatically map messy CSV/Excel columns to your entity properties |
| **Document extraction** | [AI.Extraction](/ai/document-extraction/) | Turn a PDF invoice into a typed `InvoiceData` C# record |
| **Natural language query** | [Querying.AI](/ai/natural-language-query/) | Users type "unpaid invoices from last week" → structured filters |
| **Semantic search** | [AI.VectorData](/ai/semantic-search/) | Find documents by meaning, build RAG knowledge bases |
...
- [Import Mapping](/ai/import-mapping/) — AI-powered column mapping for CSV/Excel imports
- [Document Extraction](/ai/document-extraction/) — structured data extraction from PDFs
- [Natural Language Query](/ai/natural-language-query/) — search with plain language
- [Semantic Search & RAG](/ai/semantic-search/) — vector-based similarity search and knowledge bases

For the core module reference (providers, workspaces, configuration), see
[Granit.AI module reference](/reference/modules/ai/).
