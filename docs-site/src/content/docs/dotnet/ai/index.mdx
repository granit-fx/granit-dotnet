...
|------------|--------|-------------|
| **Chat & generation** | [Granit.AI](/dotnet/ai/module/) | Workspace-managed access to `IChatClient` (OpenAI, Azure, Claude, Ollama) |
...
[Granit.AI module reference](/dotnet/ai/module/).
