...
design. The [Hexagonal Architecture](./patterns/hexagonal-architecture/)
and [Layered Architecture](./patterns/layered-architecture/) pattern
...
The [REPR pattern](./patterns/repr/) already groups endpoints by feature,
and the [Vertical Slice Architecture](./patterns/vertical-slice-architecture/)
...
- [Hexagonal Architecture — Ports & Adapters](./patterns/hexagonal-architecture/)
- [Layered Architecture — Module Layer Split](./patterns/layered-architecture/)
- [Vertical Slice Architecture — Feature-Organized Code](./patterns/vertical-slice-architecture/)
- [REPR — Request-Endpoint-Response](./patterns/repr/)
- [CQRS — Reader/Writer Separation](./patterns/cqrs/)
- [DDD Aggregate Roots](./patterns/ddd-aggregate-roots/)
- [ADR-017 — DDD Aggregate Root & Value Object Strategy](./adr/017-ddd-aggregate-value-object-strategy/)
- [Modular Monolith vs Microservices](../concepts/modular-monolith-vs-microservices/)
