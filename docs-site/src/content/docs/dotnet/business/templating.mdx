...
(email, SMS, push notifications). Templates are strongly typed, support culture
fallback, and follow a full lifecycle with ISO 27001 audit trail (Draft,
PendingReview, Published, Archived). For binary document output (PDF, Excel), see
