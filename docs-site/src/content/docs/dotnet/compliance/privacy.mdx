...
| ------- | ---- | ---------- |
| `Granit.Privacy` | GDPR data export/deletion orchestration, legal agreements | `Granit.Core`, `Granit.BackgroundJobs` |
...
| <Badge text="POST" variant="success" /> | `/deletion/{requestId}/cancel` | CancelPrivacyDeletion | `Privacy.Deletion.Cancel` |
| <Badge text="GET" variant="note" /> | `/deletion/{requestId}` | GetPrivacyDeletionStatus | `Privacy.Deletion.Read` |
| <Badge text="GET" variant="note" /> | `/deletion` | ListPrivacyDeletions | `Privacy.Deletion.Read` |
...
| `Privacy.Deletion.Execute` | Request, view, and cancel personal data deletion |
