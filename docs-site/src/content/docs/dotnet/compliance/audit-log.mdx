...
| ------- | ---- | ---------- |
| `Granit.Auditing` | Domain types, enums, `IAuditLogReader`, `IAuditLogWriter`, options | `Granit`, `Granit.QueryEngine` |
| `Granit.Auditing.EntityFrameworkCore` | `AuditLogDbContext`, interceptor, Channel persistence, cleanup worker | `Granit.Auditing`, `Granit.Persistence` |
