...
- [Privacy module](/dotnet/compliance/privacy/) -- GDPR data export, erasure, legal agreements
- [Authentication module](/dotnet/security/authentication/) -- Session-based authentication
- [Timing module](/dotnet/core/time-provider-clock/) -- `IClock` used for cookie expiry calculation
