...
- Granit.MultiTenancy.Wolverine — Automatic tenant provisioning handler
...
| `Granit.MultiTenancy.Wolverine` | `TenantProvisioningHandler` — automatic tenant provisioning on creation |
