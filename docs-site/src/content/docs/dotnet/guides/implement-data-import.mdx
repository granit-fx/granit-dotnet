...
- [Add background jobs](/guides/add-background-jobs/) to schedule recurring imports
- [Set up notifications](/guides/set-up-notifications/) to alert users when imports complete
- [Granit.DataExchange reference](/reference/modules/data-exchange/) for the full API surface and store interfaces
