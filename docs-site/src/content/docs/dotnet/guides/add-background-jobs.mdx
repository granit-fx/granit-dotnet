...
- [Set up notifications](/guides/set-up-notifications/) to alert users when jobs complete
- [Implement webhooks](/guides/implement-webhooks/) to notify external systems of job results
- [Granit.BackgroundJobs reference](/reference/modules/background-jobs/) for the full API surface and store interfaces
