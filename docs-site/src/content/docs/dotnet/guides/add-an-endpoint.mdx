...
- A working Granit module (see [Create a module](/guides/create-a-module/))
...
Granit.ExceptionHandling automatically converts unhandled exceptions into Problem
...
- [Add API versioning](/guides/add-api-versioning/) -- version your endpoints with URL segments
- [Configure multi-tenancy](/guides/configure-multi-tenancy/) -- isolate data per tenant
- [API & Web reference](/reference/modules/api-web/) -- full API module documentation
