...
`GranitTimingModule`, `GranitGuidsModule`, and `GranitSecurityModule`. You do
...
- [Add an endpoint](/guides/add-an-endpoint/) -- expose your module via Minimal API
- [Configure multi-tenancy](/guides/configure-multi-tenancy/) -- add tenant isolation to your module
- [Granit.Core reference](/reference/modules/core/) -- module system internals
