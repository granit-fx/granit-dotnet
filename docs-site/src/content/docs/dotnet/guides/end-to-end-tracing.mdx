...
- [Configure blob storage](/guides/configure-blob-storage/) -- blob storage
  operations emit their own ActivitySource spans
- [Implement a workflow](/guides/implement-workflow/) to trace workflow
  transitions across async handlers
- [Observability reference](/reference/modules/observability/) for the complete
