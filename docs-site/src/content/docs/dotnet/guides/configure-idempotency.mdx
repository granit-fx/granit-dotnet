...
Granit.Idempotency provides Stripe-style HTTP idempotency for your API endpoints.
...
- [Granit.Caching concept](/concepts/configuration/) for distributed cache and encryption setup
- [Set up notifications](/guides/set-up-notifications/) to notify users of completed operations
- [Granit.Idempotency reference](/reference/modules/api-web/) for the full configuration and service registration details
