...
- [Configure multi-tenancy](/guides/configure-multi-tenancy/) -- tenant-aware cache keys
- [Add an endpoint](/guides/add-an-endpoint/) -- use cached data in your API endpoints
- [Caching reference](/reference/modules/caching/) -- full architecture and service registration details
