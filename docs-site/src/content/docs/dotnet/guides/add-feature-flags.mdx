...
hybrid L1/L2 caching. Three value types cover common scenarios: toggles, numeric
...
Results are cached by `IHybridCache` (L1 in-process + L2 Redis) and invalidated
...
- [Manage application settings](/guides/manage-application-settings/) -- runtime settings with cascading resolution
- [Settings and Features reference](/reference/modules/settings-features/) -- full API and configuration details
- [Create a module](/guides/create-a-module/) -- build a module that uses feature checks
