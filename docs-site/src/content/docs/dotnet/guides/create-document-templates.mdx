...
- [Implement a workflow](/guides/implement-workflow/) to add approval cycles
  to template publication (Draft -> PendingReview -> Published)
- [Set up localization](/guides/set-up-localization/) for culture-specific
  template resolution
- [Templating reference](/reference/modules/templating/) for the complete API
  surface
