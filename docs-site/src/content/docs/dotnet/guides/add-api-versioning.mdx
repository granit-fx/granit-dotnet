...
- Familiarity with [Minimal API endpoints](/guides/add-an-endpoint/)
...
`GranitApiDocumentationModule` depends on `GranitApiVersioningModule` transitively,
...
- [Add an endpoint](/guides/add-an-endpoint/) -- create endpoints with validation and error handling
- [Configure multi-tenancy](/guides/configure-multi-tenancy/) -- add tenant headers to versioned APIs
- [API & Web reference](/reference/modules/api-web/) -- full API documentation module details
