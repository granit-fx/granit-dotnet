...
- [Settings, Features & Reference Data](../dotnet/infrastructure/settings/) -- full API reference for `ISettingProvider`, `ISettingManager`, and endpoints
- [Vault & Encryption](../dotnet/security/vault-encryption/) -- secret management for Options-level configuration
