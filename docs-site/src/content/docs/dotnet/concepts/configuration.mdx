...
- [Settings, Features & Reference Data](../reference/modules/settings-features/) -- full API reference for `ISettingProvider`, `ISettingManager`, and endpoints
- [Vault & Encryption](../reference/modules/vault-encryption/) -- secret management for Options-level configuration
- [Caching](../reference/modules/caching/) -- cache layer used by Settings for value resolution
