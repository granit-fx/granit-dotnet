...
design. The [Hexagonal Architecture](../architecture/patterns/hexagonal-architecture/)
and [Layered Architecture](../architecture/patterns/layered-architecture/) pattern
...
The [REPR pattern](../architecture/patterns/repr/) already groups endpoints by feature,
and the [Vertical Slice Architecture](../architecture/patterns/vertical-slice-architecture/)
...
- [Hexagonal Architecture — Ports & Adapters](../architecture/patterns/hexagonal-architecture/)
- [Layered Architecture — Module Layer Split](../architecture/patterns/layered-architecture/)
- [Vertical Slice Architecture — Feature-Organized Code](../architecture/patterns/vertical-slice-architecture/)
- [REPR — Request-Endpoint-Response](../architecture/patterns/repr/)
- [CQRS — Reader/Writer Separation](../architecture/patterns/cqrs/)
- [DDD Aggregate Roots](../architecture/patterns/ddd-aggregate-roots/)
- [ADR-017 — DDD Aggregate Root & Value Object Strategy](../architecture/adr/017-ddd-aggregate-value-object-strategy/)
