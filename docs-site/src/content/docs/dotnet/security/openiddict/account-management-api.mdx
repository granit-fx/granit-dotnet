...
| [Two-factor](#two-factor-authentication-totp) | 5 | Authenticated |
| [External logins](#external-logins) | 4 | Mixed |
| [Passkeys](#passkeys-webauthn--fido2) | 6 | Mixed |
...
[`GranitOpenIddictClientOptions`](./configuration/#granitopeniddictclientoptions).
...
Validates that the provider is configured in `GranitOpenIddictClientOptions.Providers`.
...
| `AdminOidcCreateApplicationRequestValidator` | `AdminOidcCreateApplicationRequest` |
| `AdminOidcCreateScopeRequestValidator` | `AdminOidcCreateScopeRequest` |
