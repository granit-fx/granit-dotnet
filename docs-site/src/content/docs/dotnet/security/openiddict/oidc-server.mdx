...
The server supports [Pushed Authorization Requests (RFC 9126)](/dotnet/security/openiddict/advanced/par/)
...
The server supports [DPoP (RFC 9449)](/dotnet/security/openiddict/advanced/dpop/)
