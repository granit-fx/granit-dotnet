...
automatically by `AddGranitOpenIddictEntityFrameworkCore()`. No additional
...
alongside [DPoP](/dotnet/security/openiddict/advanced/dpop/) and PKCE.
...
- [DPoP (Proof-of-Possession)](/dotnet/security/openiddict/advanced/dpop/) — bind tokens to cryptographic keys
