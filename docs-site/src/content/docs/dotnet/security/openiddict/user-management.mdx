...
`Granit.Identity.Local.AspNetCore` registers `AspNetIdentityProvider` as the
...
:::caution
Do **NOT** add `Granit.Identity.Federated.EntityFrameworkCore` alongside `Granit.Identity.Local.AspNetCore`.
