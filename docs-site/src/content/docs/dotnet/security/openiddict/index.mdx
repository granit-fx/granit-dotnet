...
- Granit.OpenIddict/ Abstractions, entities, options, permissions, events
  ...
  - Granit.Identity.Local.AspNetCore/ IIdentityProvider bridge (AspNetIdentityProvider)
...
| `Granit.Identity.Local.AspNetCore` | `AspNetIdentityProvider` implementing all 7 `IIdentityProvider` sub-interfaces |
...
graph TD
    ...
    IOID[Granit.Identity.Local.AspNetCore] --> IDEN
    IOID --> EFC
...
```csharp
[DependsOn(
    typeof(GranitIdentityLocalAspNetCoreModule),
