...
- **[Security](/dotnet/security/bff/security/)** — deep dive into cookie hardening, CSRF, and session management
- **[YARP Proxy](/dotnet/security/bff/yarp-proxy/)** — route configuration and multi-service proxying
