...
Never hardcode the client secret. Use [Granit.Vault](/dotnet/security/vault-encryption/)
...
- **[Security](/dotnet/security/bff/security/)** — harden cookies, enable cache encryption, configure CSRF
- **[YARP Proxy](/dotnet/security/bff/yarp-proxy/)** — advanced routing, multi-service, WebSocket proxying
