...
Granit.Privacy implements GDPR data subject rights (Art. 15–18): data export
orchestration via saga, right to erasure with cascading notifications, and legal
agreement tracking.
