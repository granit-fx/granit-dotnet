...
- Granit.Identity/ Abstractions (7 interfaces), null defaults
  ...
  - Granit.Identity.Local.AspNetCore IIdentityProvider bridge for OpenIddict (local store)
...
| `Granit.Identity.Local.AspNetCore` | IIdentityProvider bridge for OpenIddict (local store) | `Granit.Identity`, `Granit.OpenIddict.EntityFrameworkCore` |
...
graph TD
    ...
    ILA[Granit.Identity.Local.AspNetCore] --> I
