...
| `Granit.Identity.Local.AspNetIdentity` | IIdentityProvider bridge for OpenIddict (local store) | `Granit.Identity`, `Granit.OpenIddict.EntityFrameworkCore` |
...
graph TD
    ...
    ILA[Granit.Identity.Local.AspNetIdentity] --> I
