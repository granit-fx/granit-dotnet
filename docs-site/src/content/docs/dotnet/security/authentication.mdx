...
`GranitJwtBearerKeycloakModule` for `GranitJwtBearerEntraIdModule` and your
...
```csharp
[DependsOn(typeof(GranitJwtBearerEntraIdModule))]
public class AppModule : GranitModule { }
```
...
```csharp
[DependsOn(typeof(GranitJwtBearerCognitoModule))]
public class AppModule : GranitModule { }
```
...
```csharp
[DependsOn(typeof(GranitJwtBearerGoogleCloudModule))]
public class AppModule : GranitModule { }
```
...
`GranitJwtBearerKeycloakModule` post-configures JWT Bearer with Keycloak-specific behavior:
...
`GranitJwtBearerEntraIdModule` post-configures JWT Bearer with Entra ID-specific behavior:
...
`GranitJwtBearerCognitoModule` post-configures JWT Bearer with Cognito-specific behavior:
...
|----------|-----------|---------|
| Modules | `GranitJwtBearerModule`, `GranitJwtBearerKeycloakModule`, `GranitJwtBearerEntraIdModule`, `GranitJwtBearerCognitoModule`, `GranitJwtBearerGoogleCloudModule`, `GranitAuthenticationOpenIddictModule` | — |
