...
| `TagName` | `ApiKeysEndpoints` | `"API Keys"` | OpenAPI tag (Title Case With Spaces — see [tag conventions](/dotnet/api/conventions/)). |
...
metadata elements](/dotnet/api/conventions/) and is gated by a granular permission
(see next section).
