...
| Phase | Scope | Status |
|-------|-------|--------|
| **1** | Subscriptions + Invoicing + Payments (Stripe/Mollie stubs) + Metering | Implemented |
| **2** | SEPA providers, Invoicing.Internal (PDF), Invoicing.Odoo, EU VAT, Stripe/Mollie full | Planned |
