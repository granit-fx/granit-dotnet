...
Granit provides a complete SaaS & Commerce ecosystem through four interdependent modules.
Together they cover the full monetization lifecycle: **plans → subscriptions → usage tracking →
invoicing → payment collection**, with sovereignty-first design (SEPA transfer works without
...
| Phase | Scope | Status |
|-------|-------|--------|
| **1** | Subscriptions + Invoicing + Payments (Stripe full, Mollie stub) + Metering + Notifications | Implemented |
| **2** | Mollie full, SEPA providers, Invoicing.Internal (PDF), Invoicing.Odoo, EU VAT, email templates | Planned |
| **3** | Self-hosted dunning, credit/balance system, multi-currency, Granit.Commerce | Planned |
