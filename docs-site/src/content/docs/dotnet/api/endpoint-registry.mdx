...
| <Badge text="POST" variant="success" /> | `/oidc/applications` | CreateOidcApplication | `OpenIddict.Applications.Create` | 201 / 409 |
| <Badge text="DELETE" variant="danger" /> | `/oidc/applications/{clientId}` | DeleteOidcApplication | `OpenIddict.Applications.Delete` | 204 / 404 |
...
| <Badge text="POST" variant="success" /> | `/oidc/scopes` | CreateOidcScope | `OpenIddict.Scopes.Create` | 201 / 409 |
| <Badge text="DELETE" variant="danger" /> | `/oidc/scopes/{scopeName}` | DeleteOidcScope | `OpenIddict.Scopes.Delete` | 204 / 404 |
...
| <Badge text="GET" variant="note" /> | `/deletion/{requestId}` | GetPrivacyDeletionStatus | `Privacy.Deletion.Execute` |
| <Badge text="GET" variant="note" /> | `/deletion` | ListPrivacyDeletions | `Privacy.Deletion.Execute` |
