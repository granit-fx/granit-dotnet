...
| Method | Route | Operation | Permission |
|--------|-------|-----------|------------|
| <Badge text="GET" variant="note" /> | `/oidc/applications` | ListOidcApplications | `OpenIddict.Applications.Read` |
| <Badge text="POST" variant="success" /> | `/oidc/applications` | CreateOidcApplication | `OpenIddict.Applications.Create` |
| <Badge text="DELETE" variant="danger" /> | `/oidc/applications/{clientId}` | DeleteOidcApplication | `OpenIddict.Applications.Delete` |
| <Badge text="POST" variant="success" /> | `/oidc/applications/{clientId}/rotate-secret` | RotateOidcApplicationSecret | `OpenIddict.Applications.Rotate` |

#### OIDC Scopes

| Method | Route | Operation | Permission |
|--------|-------|-----------|------------|
| <Badge text="GET" variant="note" /> | `/oidc/scopes` | ListOidcScopes | `OpenIddict.Scopes.Read` |
| <Badge text="POST" variant="success" /> | `/oidc/scopes` | CreateOidcScope | `OpenIddict.Scopes.Create` |
| <Badge text="DELETE" variant="danger" /> | `/oidc/scopes/{scopeName}` | DeleteOidcScope | `OpenIddict.Scopes.Delete` |

#### OIDC Authorizations

| Method | Route | Operation | Permission |
|--------|-------|-----------|------------|
| <Badge text="GET" variant="note" /> | `/oidc/authorizations` | ListOidcAuthorizations | `OpenIddict.Authorizations.Read` |
| <Badge text="DELETE" variant="danger" /> | `/oidc/authorizations/{id}` | RevokeOidcAuthorization | `OpenIddict.Authorizations.Revoke` |
| <Badge text="DELETE" variant="danger" /> | `/oidc/authorizations/user/{userId}` | RevokeUserOidcAuthorizations | `OpenIddict.Authorizations.Revoke` |
