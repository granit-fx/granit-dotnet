...
Granit.ApiVersioning adds RFC 8594 deprecation headers (`Sunset`, `Deprecation`, `Link`)
so clients receive advance notice of upcoming removals — no more surprise breakages.

Granit.ApiVersioning configures [Asp.Versioning](https://github.com/dotnet/aspnet-api-versioning)
