...
Granit.ApiDocumentation generates OpenAPI documents and serves the
[Scalar](https://scalar.com) interactive UI. One OpenAPI document is generated per
declared API major version. Supports JWT Bearer and OAuth2 Authorization Code with
PKCE for interactive authentication.
