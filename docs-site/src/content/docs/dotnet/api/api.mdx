...
- [Security module](./authentication/) — JWT Bearer authentication, authorization
- [Caching module](./caching/) — `ICacheValueEncryptor` used by idempotency store
- [Core module](../core/module-system/) — Exception hierarchy (`BusinessException`, `IHasErrorCode`)
