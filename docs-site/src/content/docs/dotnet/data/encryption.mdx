...
3. **Configure encryption**
   ...
   See [Vault & Encryption](/dotnet/data/vault-encryption/) for full provider configuration.
...
ever leaving Vault). See [Vault key rotation](/dotnet/data/vault-encryption/#key-rotation).
:::
...
- [Vault & Encryption](/dotnet/data/vault-encryption/) — provider configuration, key rotation, `ITransitEncryptionService`
