---
title: Storage & Imaging
description: Multi-provider blob storage (S3, Azure, Google Cloud Storage, FileSystem, Database) with presigned URLs, proxy endpoints, validation pipeline, tenant isolation, image processing (WebP/AVIF, EXIF stripping)
sidebar:
  order: 16
---
...
- [Security module](./authentication/) -- Authorization, tenant isolation
