    ...
    : IValidateOptions<GranitBffOptions>
{
    ...
    private static void ValidateCsrfHmacKey(GranitBffOptions options, List<string> failures)
    {
    ...
    private static void ValidateFrontends(GranitBffOptions options, List<string> failures)
    {
