...
/// <summary>
/// OpenTelemetry metrics for the Magick.NET image processing provider.
/// Meter: <c>Granit.Imaging.MagickNet</c>.
/// </summary>
/// <remarks>
...
/// </remarks>
public sealed class ImagingMagickNetMetrics(IMeterFactory meterFactory)
{
    /// <summary>The meter name for this module.</summary>
    public const string MeterName = "Granit.Imaging.MagickNet";
