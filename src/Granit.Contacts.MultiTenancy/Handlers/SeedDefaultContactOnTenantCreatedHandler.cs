...
namespace Granit.Contacts.MultiTenancy.Handlers;

/// <summary>
/// Wolverine-discovered handler that seeds the host-scoped <c>Granit.Contacts.Domain.Contact</c>
/// representing every newly created tenant via <see cref="IDefaultContactSeeder"/>. Idempotent —
...
public class SeedDefaultContactOnTenantCreatedHandler
{
    public static Task HandleAsync(
        TenantCreatedEvent @event,
        IDefaultContactSeeder seeder,
