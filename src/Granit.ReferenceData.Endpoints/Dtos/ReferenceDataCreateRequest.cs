...
/// <param name="Metadata">Optional extra properties (key-value pairs stored in JSON bag).</param>
public sealed record ReferenceDataCreateRequest(
    ...
    Dictionary<string, string>? Metadata = null) : IReferenceDataMutableFields;
