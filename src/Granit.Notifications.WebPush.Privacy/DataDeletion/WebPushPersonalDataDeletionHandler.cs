...
namespace Granit.Notifications.WebPush.Privacy.DataDeletion;

/// <summary>
/// Wolverine handler that erases a data subject's browser Web Push subscriptions on a
...
public class WebPushPersonalDataDeletionHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new PersonalDataDeletedEto(
            @event.RequestId,
            WebPushPrivacyDataProvider.ProviderName,
