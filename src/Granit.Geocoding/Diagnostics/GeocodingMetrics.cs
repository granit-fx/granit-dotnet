...
/// <summary>
/// OpenTelemetry metrics for the geocoding module.
/// Meter: <c>Granit.Geocoding</c>.
/// </summary>
/// <remarks>
/// Geocoding is a global, stateless infrastructure concern, so the mandatory <c>tenant_id</c> tag is always the
/// coalesced default <c>"global"</c>. No tag ever carries the address value (GDPR data-minimisation).
/// </remarks>
public sealed class GeocodingMetrics
{
    /// <summary>The meter name.</summary>
    public const string MeterName = "Granit.Geocoding";
    ...
    public GeocodingMetrics(IMeterFactory meterFactory)
    {
    ...
    /// <summary>Records the end-to-end duration of a geocode lookup.</summary>
