...
/// Sums hourly usage aggregates within the current billing period and compares
/// against the limit returned by <see cref="IQuotaLimitProvider"/>.
/// </summary>
    ...
    IClock clock) : IQuotaChecker
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BillingPeriodBoundaries? period = await billingPeriodProvider
            .GetCurrentPeriodAsync(tenantId, cancellationToken)
