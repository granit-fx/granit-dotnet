    ...
    Func<IAwsSesTransport>? transportFactory = null) : IEmailSender
{
    ...
    public async Task SendAsync(EmailMessage message, CancellationToken cancellationToken = default)
    {
        ...
        using Activity? activity = NotificationsAwsSesActivitySource.Source.StartActivity(
            NotificationsAwsSesActivitySource.Operations.SendEmail);
        activity?.SetTag(NotificationsAwsSesActivitySource.Tags.Region, ses.Region);
