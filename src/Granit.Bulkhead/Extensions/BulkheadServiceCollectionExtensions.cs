...
namespace Granit.Bulkhead.Extensions;
...
public static class BulkheadServiceCollectionExtensions
{
    ...
    private static IServiceCollection AddGranitBulkheadCore(this IServiceCollection services)
    {
        ...
        // Background cleanup service. The HTTP 503 mapping lives in
        // Granit.Http.Bulkhead (AddGranitHttpBulkhead) — this core package is
        // transport-agnostic (ADR-062).
