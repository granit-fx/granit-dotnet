...
/// Meter: <c>Granit.Querying.AI</c>.
/// </summary>
public sealed class QueryingAIMetrics
{
    public const string MeterName = "Granit.Querying.AI";
    ...
    public QueryingAIMetrics(IMeterFactory meterFactory)
    {
