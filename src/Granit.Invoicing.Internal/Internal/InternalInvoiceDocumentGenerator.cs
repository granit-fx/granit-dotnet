...
namespace Granit.Invoicing.Internal.Internal;

/// <summary>
/// Self-hosted invoice PDF generator using Granit.Templating + Granit.DocumentGeneration.
/// </summary>
internal sealed partial class InternalInvoiceDocumentGenerator(
    IDocumentGenerator documentGenerator,
    ILogger<InternalInvoiceDocumentGenerator> logger) : IInvoiceDocumentGenerator
{
    /// <inheritdoc/>
