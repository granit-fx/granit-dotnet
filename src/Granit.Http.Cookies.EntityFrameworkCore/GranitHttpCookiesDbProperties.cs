...
/// <summary>
/// Provides configurable table-naming properties for the Cookies EF Core module.
/// </summary>
/// <remarks>
/// <para>
/// These properties control the table prefix and schema used by all entity configurations
/// in <c>Granit.Http.Cookies.EntityFrameworkCore</c>. Both the internal
/// <c>CookiesDbContext</c> and a host's <c>ConfigureCookiesModule()</c> call read the same
/// static values, ensuring migration-time and runtime SQL stay in sync.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public static class GranitHttpCookiesDbProperties
{
    /// <summary>
    /// Table name prefix for all consent-ledger tables. Default: <c>"cookie_consent_"</c>.
    /// </summary>
    public static string DbTablePrefix { get; set; } = "cookie_consent_";
