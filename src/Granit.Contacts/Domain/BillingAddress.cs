...
/// <summary>
/// Canonical billing address attached to a <see cref="Contact"/>. Distinct from the multi-typed
/// <see cref="ContactAddress"/> collection on purpose — billing carries legal weight (VAT number,
