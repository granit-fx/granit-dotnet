...
/// <summary>
/// Resolves the default host-scoped <see cref="Contact"/> that represents a given
...
/// (constant <see cref="ContactExternalProviderNames.Tenant"/>). A host-scoped contact
...
/// billing references to <c>ContactId</c> without losing the tenant association.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public interface IDefaultContactResolver
{
    /// <summary>
    ...
    /// </summary>
    Task<Contact?> GetDefaultForTenantAsync(Guid tenantId, CancellationToken cancellationToken = default);
}
