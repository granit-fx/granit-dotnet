...
namespace Granit.EntityMerge.EntityFrameworkCore.Extensions;

/// <summary>
/// Registration helpers for the EF Core merge orchestrator.
/// </summary>
public static class EntityMergeEntityFrameworkCoreHostApplicationBuilderExtensions
{
    /// <summary>
    ...
    /// <c>Granit.EntityMerge.Extensions.EntityMergeServiceCollectionExtensions</c>.
    /// </summary>
    public static IHostApplicationBuilder AddGranitEntityMergeEntityFrameworkCore(
        ...
        Action<DbContextOptionsBuilder> configure)
    {
        ...
        builder.Services.AddGranitDbContext<EntityMergeDbContext>(configure);

        // Bind orchestrator options (timeout, idempotency retention) from the EntityMerge
        // section. Validates DataAnnotations + fail-fast on misconfiguration.
        builder.Services.AddOptions<EntityMergeOptions>()
            .BindConfiguration(EntityMergeOptions.SectionName)
        ...
        builder.Services.TryAddSingleton<IEntityMergeSecretProvider, StringEncryptionEntityMergeSecretProvider>();
