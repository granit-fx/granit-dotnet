...
namespace Granit.QueryEngine.Diagnostics;

/// <summary>
/// OpenTelemetry metrics for the query engine module.
/// Meter: <c>Granit.QueryEngine</c>.
/// </summary>
public sealed class QueryEngineMetrics
{
    ...
    public QueryEngineMetrics(IMeterFactory meterFactory)
    {
