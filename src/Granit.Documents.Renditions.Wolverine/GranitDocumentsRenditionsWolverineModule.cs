using Granit.Documents.Renditions.Wolverine.Extensions;
...
public sealed class GranitDocumentsRenditionsWolverineModule : GranitModule
{
    /// <inheritdoc />
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.AddGranitDocumentsRenditionsWolverine();
    }
}
