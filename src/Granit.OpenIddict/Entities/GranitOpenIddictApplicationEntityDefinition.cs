...
/// <summary>
/// Phase 2 EntityDefinition for <see cref="GranitOpenIddictApplication"/> —
...
/// </summary>
public sealed class GranitOpenIddictApplicationEntityDefinition : EntityDefinition<GranitOpenIddictApplication>
{
    /// <inheritdoc />
    public override string Name => "Granit.OpenIddict.Application";

    /// <inheritdoc />
    protected override void Configure(EntityDefinitionBuilder<GranitOpenIddictApplication> builder) =>
        builder
