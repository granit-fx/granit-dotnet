...
/// <summary>
/// Generates password reset tokens and publishes <see cref="Events.PasswordResetRequestedEto"/>.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Generates a reset token for the user and publishes <see cref="Events.PasswordResetRequestedEto"/>.
    /// </summary>
