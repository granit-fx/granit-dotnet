...
/// <summary>
/// Provides configurable table-naming properties for the Granit.Documents EF Core module.
/// </summary>
/// <remarks>
/// <para>
/// These properties control the table prefix and schema used by all entity configurations
/// in <c>Granit.Documents.EntityFrameworkCore</c>. Both the internal <c>DocumentsDbContext</c>
/// and the host's <c>Configure*Module()</c> call read the same static values, ensuring
/// migration-time and runtime SQL stay in sync.
/// </para>
/// <para>
/// <b>Important:</b> Set these properties at application startup, before
/// <c>ConfigureServices</c> completes. EF Core caches the compiled
/// <see cref="Microsoft.EntityFrameworkCore.Metadata.IModel"/> after first use — later
/// mutations have no effect.
/// </para>
/// </remarks>
public static class GranitDocumentsDbProperties
{
    /// <summary>
    /// Table name prefix for all <c>Granit.Documents</c> tables. Default: <c>"documents_"</c>.
    /// </summary>
