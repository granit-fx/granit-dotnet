    ...
    AIProviderCredential credential) : IChatClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            using Activity? activity = StartActivity(AIAnthropicActivitySource.ChatOperation);
            try
            {
    ...
    {
        using Activity? activity = StartActivity(AIAnthropicActivitySource.ChatStreamOperation);
    ...
    {
        Activity? activity = AIAnthropicActivitySource.Source.StartActivity(operationName, ActivityKind.Client);
        if (activity is null)
        {
            return null;
        }
