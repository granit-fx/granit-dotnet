...
/// it to context under the caller's ACLs via the <c>Granit.Mentions</c> picker facade;
/// a mention the caller cannot see resolves to nothing and is never leaked into the prompt.
/// </summary>
/// <param name="Type">The mention type, matching a lookup source tagged mentionable (e.g. <c>user</c>).</param>
