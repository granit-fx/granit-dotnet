...
namespace Granit.Notifications.AzureNotificationHubs.Extensions;
...
public static class AzureNotificationHubsServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddGranitNotificationsAzureNotificationHubs(
        ...
        Action<AzureNotificationHubsOptions>? configure = null)
    {
        ...
        GranitActivitySourceRegistry.Register(NotificationsAzureNotificationHubsActivitySource.Name);
