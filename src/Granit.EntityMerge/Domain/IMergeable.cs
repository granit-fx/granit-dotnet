...
namespace Granit.EntityMerge.Domain;
...
// without taking a dependency on Granit.EntityMerge.
    ...
    where TSelf : Entity, IMergeable<TSelf>
{
    ...
    /// <summary>
    /// Folds <paramref name="loser"/> into this aggregate. Throws <see cref="Granit.EntityMerge.Exceptions.MergeException"/>
