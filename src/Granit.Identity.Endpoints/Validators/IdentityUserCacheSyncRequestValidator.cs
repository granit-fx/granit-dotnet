...
/// <summary>
/// Validates the <see cref="IdentityUserCacheSyncRequest"/> body for user cache synchronization.
/// </summary>
internal sealed class IdentityUserCacheSyncRequestValidator : GranitValidator<IdentityUserCacheSyncRequest>
{
    /// <summary>Maximum number of user IDs in a single sync request.</summary>
    ...
    public IdentityUserCacheSyncRequestValidator()
    {
        RuleFor(x => x.UserIds)
            .NotEmpty()
