...
/// <summary>
/// Handler for <see cref="CreditExpirationScanJob"/>. Queries expired promotional credits,
/// debits the remaining balance, and publishes <see cref="CreditExpiredEto"/>.
/// </summary>
internal static partial class CreditExpirationScanHandler
{
    public static async Task HandleAsync(
        ...
        ILogger<CreditExpirationScanJob> logger,
        CancellationToken cancellationToken)
    {
        ...
        {
            // Load the owning account to check if this credit has already been expired.
            ...
            // Check if an expiration debit already exists for this credit (idempotency).
