...
namespace Granit.Contacts.Privacy.DataDeletion;

/// <summary>
/// Wolverine-discovered integration-event handler that fulfils the GDPR Article 17
/// erasure obligation for the <see cref="Contact"/> aggregate. Pseudonymises every PII
...
public class ContactsPersonalDataDeletionHandler
{
    /// <summary>Provider name recorded on the audit fragment.</summary>
    public const string ProviderName = "contacts";
