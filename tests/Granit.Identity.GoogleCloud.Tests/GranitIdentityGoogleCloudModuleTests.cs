...
public sealed class GranitIdentityGoogleCloudModuleTests
{
    [Fact]
    public void Module_InheritsFromGranitModule()
    {
        GranitIdentityGoogleCloudModule module = new();
    ...
    {
        Type moduleType = typeof(GranitIdentityGoogleCloudModule);
