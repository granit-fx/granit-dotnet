...
public sealed class TokenManagementServiceCollectionExtensionsTests
{
    ...
    private static void AddRequiredDependencies(ServiceCollection services)
    {
        ...
        services.AddSingleton(Substitute.For<Granit.Authentication.Oidc.Discovery.IDiscoveryDocumentService>());
        services.AddSingleton(Substitute.For<Granit.Authentication.Oidc.DPoP.IDPoPProofService>());
