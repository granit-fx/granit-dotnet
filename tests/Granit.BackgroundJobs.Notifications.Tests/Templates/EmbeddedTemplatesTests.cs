...
namespace Granit.BackgroundJobs.Notifications.Tests.Templates;
...
public sealed class EmbeddedTemplatesTests
{
    ...
    [
        ...
        "Templates.jobs.recurring_failing.html",
        // French variants — the second culture we ship out of the box.
        "Templates.jobs.recurring_failing.fr.html",
    ];
    ...
    {
        Assembly assembly = typeof(GranitBackgroundJobsNotificationsModule).Assembly;
