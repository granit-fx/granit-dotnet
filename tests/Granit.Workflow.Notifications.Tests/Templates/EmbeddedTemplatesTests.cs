...
namespace Granit.Workflow.Notifications.Tests.Templates;
...
public sealed class EmbeddedTemplatesTests
{
    ...
    [
        // Neutral (= EN) variant, one per notification type that ships an email channel.
        "Templates.workflow.approval_requested.html",
        // French variant — the second culture we ship out of the box.
        "Templates.workflow.approval_requested.fr.html",
    ];
    ...
    {
        Assembly assembly = typeof(GranitWorkflowNotificationsModule).Assembly;
