...
{
    [Fact]
    public void Html_HasValue0()
    {
        ((int)DocumentFormat.Html).ShouldBe(0);
    }

    [Fact]
    public void Pdf_HasValue1()
    {
        ((int)DocumentFormat.Pdf).ShouldBe(1);
    }

    [Fact]
    public void Excel_HasValue2()
    {
        ((int)DocumentFormat.Excel).ShouldBe(2);
    }
