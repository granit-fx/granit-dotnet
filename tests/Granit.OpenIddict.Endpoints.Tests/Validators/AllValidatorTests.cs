...
public sealed class AdminUserCreateRequestValidatorTests
{
    private readonly AdminUserCreateRequestValidator _validator = new();

    [Fact]
    public void Valid_Request_Passes()
    {
        AdminUserCreateRequest request = new("alice@test.com", "Alice", "Doe", null);
        _validator.TestValidate(request).ShouldNotHaveAnyValidationErrors();
    }
    ...
    {
        AdminUserCreateRequest request = new("", null, null, null);
    ...
    {
        AdminUserCreateRequest request = new("not-an-email", null, null, null);
        _validator.TestValidate(request).ShouldHaveValidationErrorFor(x => x.Email);
    }
    ...
    public void Long_FirstName_Fails()
    {
        AdminUserCreateRequest request = new("alice@test.com", new string('A', 257), null, null);
        _validator.TestValidate(request).ShouldHaveValidationErrorFor(x => x.FirstName);
    }
    ...
    public void Long_LastName_Fails()
    {
        AdminUserCreateRequest request = new("alice@test.com", null, new string('B', 257), null);
        _validator.TestValidate(request).ShouldHaveValidationErrorFor(x => x.LastName);
    }

    [Fact]
    public void Null_TemporaryPassword_Passes()
    {
        AdminUserCreateRequest request = new("alice@test.com", null, null, null);
        _validator.TestValidate(request).ShouldNotHaveAnyValidationErrors();
    }

    [Fact]
    public void Short_TemporaryPassword_Fails()
    {
        AdminUserCreateRequest request = new("alice@test.com", null, null, "short");
        _validator.TestValidate(request).ShouldHaveValidationErrorFor(x => x.TemporaryPassword);
    }

    [Fact]
    public void Valid_TemporaryPassword_Passes()
    {
        AdminUserCreateRequest request = new("alice@test.com", null, null, "P@ssw0rd123");
        _validator.TestValidate(request).ShouldNotHaveAnyValidationErrors();
    }

    [Fact]
    public void MinLength_TemporaryPassword_Passes()
    {
        AdminUserCreateRequest request = new("alice@test.com", null, null, "12345678");
        _validator.TestValidate(request).ShouldNotHaveAnyValidationErrors();
    }
}
