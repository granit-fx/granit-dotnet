...
/// instance. Tests insert and read rows under arbitrary tenant ids without setting up an
/// ambient <c>ICurrentTenant</c>, so we bypass the parameterised tenant filter installed
/// by <c>GranitDbContext</c>.
/// </summary>
