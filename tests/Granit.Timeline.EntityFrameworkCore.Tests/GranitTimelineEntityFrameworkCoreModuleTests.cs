...
public sealed class GranitTimelineEntityFrameworkCoreModuleTests
{
    ...
    {
        typeof(GranitTimelineEntityFrameworkCoreModule).IsSealed.ShouldBeTrue();
    }

    [Fact]
    public void Module_InheritsGranitModule()
    {
        typeof(GranitTimelineEntityFrameworkCoreModule).IsSubclassOf(typeof(GranitModule)).ShouldBeTrue();
    }
