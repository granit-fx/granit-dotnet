...
public sealed class QueryingEfCoreMetricsTests : IDisposable
{
    private readonly IMeterFactory _meterFactory;
    private readonly QueryingEfCoreMetrics _metrics;

    public QueryingEfCoreMetricsTests()
    {
        _meterFactory = new TestMeterFactory();
        _metrics = new QueryingEfCoreMetrics(_meterFactory);
    }
