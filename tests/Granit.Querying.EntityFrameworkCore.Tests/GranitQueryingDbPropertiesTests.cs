...
{
    [Fact]
    public void DbTablePrefix_default_is_querying_underscore()
    {
        GranitQueryingDbProperties.DbTablePrefix.ShouldBe("querying_");
    }

    [Fact]
    public void DbSchema_default_is_null()
    {
        GranitQueryingDbProperties.DbSchema.ShouldBeNull();
    }
