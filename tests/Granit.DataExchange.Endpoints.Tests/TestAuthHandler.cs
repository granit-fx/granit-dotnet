...
/// and, when present, the legacy <c>X-Test-Roles</c> header. Shared by all endpoint test classes.
/// </summary>
/// <remarks>
/// Authorization in Granit is permission-based, never role-based — permission policies gate on
/// <c>RequireClaim(PermissionClaimType, permissionName)</c>. Role claims are still emitted from
/// <see cref="RolesHeader"/> but MUST NOT gate authorization.
/// </remarks>
