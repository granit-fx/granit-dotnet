...
public sealed class BulkheadMetricsTests : IDisposable
{
    ...
    {
        using MetricCollector<long> collector = new(_meterFactory, BulkheadMetrics.MeterName, "granit.http.bulkhead.leases.active");
    ...
    {
        using MetricCollector<long> collector = new(_meterFactory, BulkheadMetrics.MeterName, "granit.http.bulkhead.requests.rejected");
