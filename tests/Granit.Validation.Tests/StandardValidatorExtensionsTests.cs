...
public sealed class StandardValidatorExtensionsTests
{
    ...
    public void Iso4217CurrencyCode_InvalidValues_FailValidation(string? code)
    {
        ...
        result.Errors[0].ErrorMessage.ShouldBe("Validation:Format:Iso4217CurrencyCode");
        result.Errors[0].ErrorCode.ShouldBe("Validation:Format:Iso4217CurrencyCode");
    }
    ...
    public void Iso8601Duration_InvalidValues_FailValidation(string? duration)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Validation:Format:Iso8601Duration");
        result.Errors[0].ErrorCode.ShouldBe("Validation:Format:Iso8601Duration");
    }
    ...
    public void Uuid_InvalidValues_FailValidation(string? uuid)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Validation:Format:Uuid");
        result.Errors[0].ErrorCode.ShouldBe("Validation:Format:Uuid");
    }
