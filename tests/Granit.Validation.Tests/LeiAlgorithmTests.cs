...
public sealed class LeiAlgorithmTests
{
    ...
    public void IsValid_ValidLei_ReturnsTrue(string lei)
    {
        LeiAlgorithm.IsValid(lei).ShouldBeTrue();
    }
    ...
    public void IsValid_InvalidLei_ReturnsFalse(string? lei)
    {
        LeiAlgorithm.IsValid(lei).ShouldBeFalse();
    }
}
