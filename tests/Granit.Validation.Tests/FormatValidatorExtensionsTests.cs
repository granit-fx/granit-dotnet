...
public sealed class FormatValidatorExtensionsTests
{
    ...
    public void Slug_InvalidValues_FailValidation(string? slug)
    {
        ...
        result.Errors[0].ErrorMessage.ShouldBe("Validation:Format:Slug");
        result.Errors[0].ErrorCode.ShouldBe("Validation:Format:Slug");
    }
    ...
    public void Base64String_InvalidValues_FailValidation(string? base64)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Validation:Format:Base64String");
        result.Errors[0].ErrorCode.ShouldBe("Validation:Format:Base64String");
    }
    ...
    public void ColorHex_InvalidValues_FailValidation(string? color)
    {
        ...
        result.IsValid.ShouldBeFalse();
        result.Errors[0].ErrorMessage.ShouldBe("Validation:Format:ColorHex");
        result.Errors[0].ErrorCode.ShouldBe("Validation:Format:ColorHex");
    }
