...
public sealed class WolverineExportCommandDispatcherTests
{
    private readonly IMessageBus _messageBus = Substitute.For<IMessageBus>();

    private WolverineExportCommandDispatcher CreateDispatcher()
    {
    ...
    {
        // Arrange
        WolverineExportCommandDispatcher dispatcher = CreateDispatcher();
