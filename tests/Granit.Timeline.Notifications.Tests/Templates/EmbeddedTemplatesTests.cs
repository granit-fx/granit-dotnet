...
namespace Granit.Timeline.Notifications.Tests.Templates;
...
public sealed class EmbeddedTemplatesTests
{
    ...
    [
        ...
        "Templates.timeline.user_mentioned.html",
        // French variant — the second culture we ship out of the box.
        "Templates.timeline.user_mentioned.fr.html",
    ];
    ...
    {
        Assembly assembly = typeof(GranitTimelineNotificationsModule).Assembly;
