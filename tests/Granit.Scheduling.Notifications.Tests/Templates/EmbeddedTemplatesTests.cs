...
namespace Granit.Scheduling.Notifications.Tests.Templates;
...
public sealed class EmbeddedTemplatesTests
{
    ...
    [
        ...
        "Templates.scheduling.action_failed.html",
        // French variants — the second culture we ship out of the box.
        "Templates.scheduling.action_failed.fr.html",
    ];
    ...
    {
        Assembly assembly = typeof(GranitSchedulingNotificationsModule).Assembly;
