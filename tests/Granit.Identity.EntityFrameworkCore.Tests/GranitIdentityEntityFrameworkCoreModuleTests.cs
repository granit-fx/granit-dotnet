...
public sealed class GranitIdentityEntityFrameworkCoreModuleTests
{
    [Fact]
    public void Module_InheritsFromGranitModule()
    {
        GranitIdentityEntityFrameworkCoreModule module = new();
    ...
    {
        Type moduleType = typeof(GranitIdentityEntityFrameworkCoreModule);
